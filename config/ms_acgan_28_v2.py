...
if __name__ == '__main__':
	...
	for k in range(N_train):
		Real_img = cv2.resize(cv2.imread(train_file_list[k]), (28, 28)).astype(np.uint8).copy()
		print "train_file_list[k]: ", train_file_list[k]
		print "Real_img.shape: ", Real_img.shape
		print "Real_img[:5]: ", Real_img[:5]
		# cv2.imwrite(path + "Real_img" + str(k) + ".jpg", Real_img)
	...
	for k in range(N_test):
		print "test_file_list[k]: ", test_file_list[k]
		Real_img = cv2.resize(cv2.imread(test_file_list[k]), (28, 28)).astype(np.uint8).copy()
		print "test_file_list[k]: ", test_file_list[k]
		print "Real_img.shape: ", Real_img.shape
		print "Real_img[:5]: ", Real_img[:5]
		# cv2.imwrite(path + "Real_img" + str(k) + ".jpg", Real_img)
	...
	for epoch in range(nb_epochs):
		...
		cv2.imwrite(path + "outputImage.jpg", np.asarray(img[:,:,np.array([2,1,0])]))
